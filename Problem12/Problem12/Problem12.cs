    ...
    class Problem12
    {
        ...
        static void Main(string[] args)
        {
            ...
            while (factorCount <= 501)
            {
                ...
                factorCount = Problem12.DetermineNumberOfFactors(triangleNumber);
            ...
            Console.WriteLine("Runtime: " + runtimeStopwatch.Elapsed.ToString());
        ...
        //(2^1)(7^2) = 98
        //(2^2)(7^2) = 196
        private static int DetermineNumberOfFactors(ulong numberToFactor)
        {
